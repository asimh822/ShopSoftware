...
class SettingsPage(QWidget):
    def __init__(self, parent=None):
        ...
        self.printer_name.setPlaceholderText(
            "Windows printer name, e.g. 'POS-80' or 'XP-58'"
        )
        rf.addRow("Printer Name:", self.printer_name)

        printer_note = QLabel(
            "Enter the exact name of your thermal printer as shown in Windows "
            "Printers & Scanners. Leave blank to show a receipt preview instead of printing."
        )
    ...
    def _test_print(self):
        ...
        from receipt import build_receipt_text, _show_preview
        text = build_receipt_text(
            ...
            shop_name    = self.shop_name.text() or "United Mobile",
            shop_address = self.shop_address.text() or "Kutchery Road, Multan",
            shop_contact = self.shop_contact.text() or "0323-9637000",
            footer_msg   = self.receipt_footer.text() or "Thank you for your purchase!",
        )
